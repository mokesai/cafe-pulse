...
const DRINK_INGREDIENTS = [
  ...
  { supplier_id: SUPPLIERS.walmart, item_name: 'Heavy Cream', unit_type: 'liter', unit_cost: 4.99, square_item_id: 'SEED-WM-CREAM-HEAVY' },
  { supplier_id: SUPPLIERS.walmart, item_name: 'Whipped Cream Can', unit_type: 'each', unit_cost: 3.49, square_item_id: 'SEED-WM-WHIP-CAN' },
  { supplier_id: SUPPLIERS.walmart, item_name: 'Vanilla Syrup', unit_type: 'ml', unit_cost: 6.99, square_item_id: 'SEED-WM-SYRUP-VANILLA' },
  
  // Odeko - specialty syrups & toppers
  { supplier_id: SUPPLIERS.odeko, item_name: 'Caramel Syrup', unit_type: 'ml', unit_cost: 8.50, square_item_id: 'SEED-ODEKO-SYRUP-CARAMEL' },
  { supplier_id: SUPPLIERS.odeko, item_name: 'Hazelnut Syrup', unit_type: 'ml', unit_cost: 8.50, square_item_id: 'SEED-ODEKO-SYRUP-HAZELNUT' },
  { supplier_id: SUPPLIERS.odeko, item_name: 'Mocha Sauce', unit_type: 'ml', unit_cost: 9.25, square_item_id: 'SEED-ODEKO-MOCHA' },
  { supplier_id: SUPPLIERS.odeko, item_name: 'Strawberry Puree', unit_type: 'ml', unit_cost: 11.00, square_item_id: 'SEED-ODEKO-PUREE-STRAWB' },
  { supplier_id: SUPPLIERS.odeko, item_name: 'Mango Puree', unit_type: 'ml', unit_cost: 11.00, square_item_id: 'SEED-ODEKO-PUREE-MANGO' },
  { supplier_id: SUPPLIERS.odeko, item_name: 'Chai Concentrate', unit_type: 'ml', unit_cost: 12.00, square_item_id: 'SEED-ODEKO-CHAI' },
  ...
  { supplier_id: SUPPLIERS.odeko, item_name: 'Caramel Drizzle Topper', unit_type: 'ml', unit_cost: 7.25, square_item_id: 'SEED-ODEKO-DRIZZLE' },
